...
const translations = {
  en: {
    ...
    proj3_title: "Superstore Sales & Profitability Analytics",
    proj3_desc: "A full data-modeling project on the same Superstore data — 5 dimension tables, 14 DAX measures, and a 3-page report with tested drill-through.",
    proj3_challenge: "Same raw data as the Excel project, but a different goal: build a proper relational data model from scratch and handle data-quality problems at the modeling level, not just in a spreadsheet.",
    proj3_solution: "Built a star schema with 5 dimension tables, solved duplicate-key issues with verified composite keys, added quartile-based profitability classification, and wrote 14 DAX measures across a 3-page report with synced slicers and drill-through.",
    proj3_result: "A complete, tested Power BI solution — including solving real problems like a circular dependency and a broken YoY calculation along the way.",
    proj4_title: "BBE Sales & Profitability Analytics",
    proj4_desc: "A consultancy-style engagement with a written report — documented data limitations, ~25 DAX measures, and business recommendations backed by evidence.",
    proj4_challenge: "A retailer needed sales analytics built to a standard where every figure could be trusted, and every data limitation was documented rather than hidden.",
    proj4_solution: "Built a star schema with ~25 DAX measures, logged every data-quality issue with a stated decision, and paired each business insight in the written report with its evidence and commercial implication.",
    proj4_result: "A 3-page dashboard plus a written consultancy report that is as clear about what the data can't tell you as what it can.",
  ...
  ar: {
    ...
    proj2_result: "لوحة بيانات مبيعات كاملة اتبنت من داتا المقياس الأساسي فيها — المبيعات — مكنش موجود أصلاً ولازم يتبني الأول. الموضوع خلاني أفكر في نموذج البيانات، مش بس الشكل المرئي، قبل ما أبني أي حاجة.",
    proj3_title: "تحليل مبيعات وربحية Superstore",
    proj3_desc: "مشروع نمذجة بيانات كامل على نفس داتا Superstore — 5 جداول Dimension، 14 مقياس DAX، وتقرير 3 صفحات فيه Drill-through مختبر.",
    proj3_challenge: "نفس البيانات الخام بتاعت مشروع Excel، لكن هدف مختلف: بناء نموذج بيانات علائقي صحيح من الصفر والتعامل مع مشاكل جودة البيانات على مستوى النموذج، مش بس في السبريد شيت.",
    proj3_solution: "بنيت Star Schema بـ5 جداول Dimension، حليت مشاكل تكرار المفاتيح بمفاتيح مركّبة اتأكدت منها، أضفت تصنيف ربحية مبني على أرباع إحصائية، وكتبت 14 مقياس DAX عبر تقرير 3 صفحات بسلايسرز متزامنة وDrill-through.",
    proj3_result: "حل Power BI كامل ومختبر — شمل حل مشاكل حقيقية زي الاعتماد الدائري وخطأ في حساب النمو السنوي في الطريق.",
    proj4_title: "تحليل مبيعات وربحية BBE",
    proj4_desc: "مشروع استشاري كامل بتقرير مكتوب — محدوديات بيانات موثقة، حوالي 25 مقياس DAX، وتوصيات تجارية مبنية على أدلة.",
    proj4_challenge: "متجر تجزئة محتاج تحليل مبيعات مبني بمعيار كل رقم فيه موثوق، وكل محدودية بيانات موثقة مش مخفية.",
    proj4_solution: "بنيت Star Schema بحوالي 25 مقياس DAX، سجلت كل مشكلة جودة بيانات بقرار واضح، وربطت كل نتيجة تجارية في التقرير المكتوب بالدليل والأثر التجاري وراها.",
    proj4_result: "داشبورد 3 صفحات مع تقرير استشاري مكتوب واضح في إيه اللي البيانات مش قادرة تقوله بنفس وضوح اللي قادرة عليه.",
    ach_tag: "الإنجازات",
    ach_h2: "الشهادات",
